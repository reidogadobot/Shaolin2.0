		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '[❗] Shaolin? Este é um recurso especial para o Causs ❌',
					ownerB: '[❗] Shaolin? Este é um recurso especial para o Causs ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de SHAOLIN. Registre-se para fazer amizade com o bot Causs por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Shaolin|17\n\n──「 SHAOLIN BOT 」──`,
			...
			const premium = ["559887583208@s.whatsapp.net","559384051080@s.whatsapp.net","553299049385@s.whatsapp.net","559885867761@s.whatsapp.net"] 
           ...
           case 'shitlist':
               ...
               break
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* SHAOLIN\n*YOUTUBE:* https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g\n*WPP:* wa.me/+559887583208\n*INSTA:* @sla._.netin\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
